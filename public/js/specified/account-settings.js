						...
						if(data.status == "ok")
						{
							if(data.user)
							{
								...
								{	
									...
									var html	= "<div class=\"col-1-4 thumbnail mrgrt15\">" + data.img + "</div>" + 
													"<div class=\"left\"><a href=\""+ data.link +"\">" + data.name + "</a></div>";
...
$(document).ready(function(e) {
    $('input[name="new_password"]').PasswordHint();
	$('input[name="conf_password"]').sameInputValue();
