...
@endif
 	...
 	<h2 class="subscribe_title" style="margin-bottom:0px">Sign me up for a free beta trial</h2>
    <p class="subscribe_pera"> Includes access to all Pro Subscription features</p>
    
 	<div id="subscription">
			    {{ Form::open(['url' => route('user.registrationOT',['code'=>$code])],['id'=>'subscribeForm']) }} 
