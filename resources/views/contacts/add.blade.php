...
@section('content')
    ...
    {{ Form::open(array('url' => route('contact.create'), 'files' => true,'id'=>'contact-create')) }}
    <div class="col-2-3">
    	 <div class="col-1-1 mrgbt15">
            {{ Form::label('fname',trans('lang.first-name'),['class'=>'it mrgbt5 required']) }}
            {{ Form::text('fname','',array('class'=>'text textInput it','placeholder'=>trans('lang.first-name'))) }}
        </div>
       
        <div class="col-1-1 mrgbt15">
            {{ Form::label('lname',trans('lang.last-name'),['class'=>'it mrgbt5']) }}
            {{ Form::text('lname','',array('class'=>'text textInput it','placeholder'=>trans('lang.last-name'))) }}
        </div>
        
        <div class="col-1-1 mrgbt15">
            {{ Form::label('title',trans('lang.title'),['class'=>'it mrgbt5']) }}
            {{ Form::text('title','',array('class'=>'text textInput it','placeholder'=>trans('lang.title'))) }}
        </div>
        ...
        <div class="col-1-1 mrgbt15">
            ...
            {{ Form::text('email','',array('class'=>'text textInput it','placeholder'=>trans('lang.email-id'))) }}
        </div>
        
        <div class="col-1-1 mrgbt15">
            {{ Form::label('cell_phone',trans('lang.cell-phone'),['class'=>'it mrgbt5']) }}
            {{ Form::text('cell_phone','',array('class'=>'text textInput it','placeholder'=>trans('lang.cell-phone'))) }}
        </div>
        
        <div class="col-1-1 mrgbt15">
            {{ Form::label('bus_phone',trans('lang.business-phone'),['class'=>'it mrgbt5']) }}
            {{ Form::text('bus_phone','',array('class'=>'text textInput it','placeholder'=>trans('lang.business-phone'))) }}
        </div>
        
        <div class="col-1-1 mrgbt15">
            {{ Form::label('address',trans('lang.address'),['class'=>'it mrgbt5']) }}
            {{ Form::textarea('address','',array('class'=>'text textInput it','placeholder'=>trans('lang.user-address'),'rows'=>5)) }}
        </div>
        
        <div class="col-1-1 mrgbt15">
            {{ Form::label('notes',trans('lang.notes'),['class'=>'it mrgbt5']) }}
            {{ Form::textarea('notes','',array('class'=>'text textInput it','placeholder'=>trans('notes'),'rows'=>5)) }}
        </div>
