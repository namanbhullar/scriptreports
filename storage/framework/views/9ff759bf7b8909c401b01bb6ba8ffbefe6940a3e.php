...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <?php echo e(Html::style("public/css/home/bootstrap.min.css")); ?>

    <?php echo e(Html::style("public/css/home/font-awesome.min.css")); ?>

    <?php echo e(Html::style("public/css/home/main.css")); ?>
    ...
    <?php echo Html::script('public/js/responsive/pages/home.js'); ?>

    <?php echo Html::style('public/plugins/fancybox/jquery.fancybox.css'); ?>

    <?php echo Html::style('public/css/home/responsive.css'); ?>

	
    <?php echo Html::style('public/css/uikit.css'); ?>
...
<body id="page-top" class="index">
    ...
    <nav class="navbar navbar-default dash-nav">
            ...
            <div class="navbar-header page-scroll dropdown" >
                ...
                <a class="navbar-brand page-scroll" href="#page-top"><?php echo e(Html::image('public/images/home/dash-logo.png')); ?></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="<?php echo e(URL::to('/directory')); ?>">Directory</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="<?php echo e(URL::to('/submission-directory')); ?>">Submissions</a>
                    </li>
                    <li>
    ...
    <header>
        ...
        <div class="dash-banner">
        	<ul class="nav navbar-nav navbar-right banner_nav">
                    ...
                    <li>
                        <a class="page-scroll" href="<?php echo e(URL::to('/contact-us')); ?>">Contact</a>
                    </li>
                    <li>
                        <a class="page-scroll login" href="<?php echo e(URL::to('/login')); ?>">Log In</a>
                    </li>
...
evaluate, and share scripts.</div>
            ...
            <div class="imac">
            	<?php echo e(Html::image("public/images/home/imac.png","Imac Logo")); ?>
            ...
            <div class="row">
                <div class="col-md-6 ">
                	<div class="portfolio-item">
                    	<?php echo e(Html::image('public/images/home/icon_pr.png','Share and Track Scripts')); ?>
...
<p style="margin-bottom:20px;">Keep track of submissions, see who views your scripts and when.</p>
                    ...
                    <div class="port_img">
                    	<?php echo e(Html::image('public/images/home/port-1.jpg','Click image to enlarge')); ?>
                ...
                <div class="col-md-6 ">
                    ...
                    <?php echo e(Html::image('public/images/home/port-2.png','Build Powerful Evaluation')); ?>
...
<p style="margin-bottom:10px;">Compare up to 5 readers' reports and merge them into one PDF file.</p>
                    ...
                    <div class="port_img">
                     <?php echo e(Html::image('public/images/home/port_1.jpg','Click image to enlarge')); ?>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 ">
                    ...
                    <?php echo e(Html::image('public/images/home/icon_pr3.png','Find Script Readers')); ?>
...
<p>Our open marketplace lets you connect directly with the talent you need.</p>
                ...
                <div class="col-md-6 ">
                	<div class="portfolio-item" style="padding-bottom:157px; border-bottom:1px solid #ecf0f1;">
                        <?php echo e(Html::image('public/images/home/icon_pr4.png','Find Work')); ?>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 cntct_wrap">
                    <?php echo Form::open(['route' => 'contact-form','method'=>"post"]); ?>
    ...
    <footer class="footer-dash">
        ...
        <div class="container">
            <div class="col-lg-3 text-center">
              <img alt="Site Logg" style="margin-top: 13px" src="<?php echo e(url('/public/images/home/dash-logo.png')); ?>">
            </div>
