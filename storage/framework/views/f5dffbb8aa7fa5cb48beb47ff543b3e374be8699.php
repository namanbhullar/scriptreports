<?php $__env->startSection('content'); ?>
    ...
    <?php echo e(Form::open(array('url' =>  route('my-document.update', ['id' => $dox->id]), 'files' => true,'id'=>'add-documentform'))); ?>

    <div class="col-2-3">
    	 <div class="col-1-1 mrgbt15">
            <?php echo e(Form::label('title',trans('lang.doc-title'),['class'=>'it mrgbt5'])); ?>

            <?php echo e(Form::text('title',$dox->title,array('class'=>'text textInput it','placeholder'=>trans('lang.doc-title')))); ?>

        </div>
        <div class="col-1-1 mrgbt15">
            <?php echo e(Form::label('type',trans('lang.doc-cat'),array('class'=>'it mrgbt5'))); ?>

            <?php echo e(Form::select('type',docTypeList(),$dox->type,['class'=>'col-1-1'])); ?>

        </div>
        <div class="col-1-1 mrgbt15">
            <?php echo e(Form::label('draft',trans('lang.draft'),['class'=>'it mrgbt5'])); ?>

            <?php echo e(Form::text('draft',$dox->draft,array('class'=>'text textInput it','placeholder'=>trans('lang.draft')))); ?>

        </div>
        <div class="col-1-1 mrgbt15">
            <?php echo e(Form::label('description',trans('lang.description'),['class'=>'it mrgbt5'])); ?>

            <?php echo e(Form::textarea('description',$dox->description,array('class'=>'text textInput it','placeholder'=>trans('lang.description'),'rows'=>2))); ?>
        ...
        <div class="col-1-1 mrgbt30">
		   ...
		   <div class="col-2-5">
           	<?php echo Form::text('upload_document_name',$dox->file_name,array('class' => 'textInput it text', 'placeholder' => trans('lang.upload-doc'),"readonly"=>"readonly",'required')); ?>
        ...
        <div class="col-1-1">
            <?php echo Form::submit("Update",['class'=>"btn btn-primary right xpul20 mrglft20",'id'=>"savBtn"]); ?>
