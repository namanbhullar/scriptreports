     ...
     <div class="clearfix"></div>
       ...
       <div class="clearfix"></div>
        <div id="template_view" class="col-1-1 ymrg10">
        	<?php echo e(Form::open(['route'=>['report.update','id'=>$script->id],'id'=>'Create_Report_Form'])); ?>
                  ...
                  <ul id="sortingtemplate" class="template-tabs left">
                   <?php if(!empty($rederinst)){ $readerpart = true; ?>	
                    ...
                    <?php if(count($bargraphs)>0){ $gridpart = true; $class =''; ?>
                    	...
                    	<li id="grid" class="<?php echo e($class); ?>"><a data-class="grid" href="javascript:void(0)" class="sorted">Grid</a></li>
                	<?php } ?>
                    ...
                    <div class="templ-categories">
                        ...
                        <?php 
						 ...
						 ?>
                            <div id="mq_<?php echo e($offset); ?>" class="mainquestion question-<?php echo e($count); ?>">
                                ...
                                <div class="templ-note">
                                    ...
                                    <div id="note_<?php echo e($question->id); ?>" class="col-23-24 no-display mrglft8">
                                        <textarea name="data[<?php echo e($category); ?>][<?php echo e($question->id); ?>][notes]" class="editers_questionAndnotes" rows="2"><?php echo $data['data'][$category][$question->id][notes]; ?></textarea>
                                    </div>
                                ...
                                <div class="templ-suggs">
                                    ...
                                    <div id="suggestion_<?php echo e($question->id); ?>" class="col-23-24 no-display mrglft8">
                                        <textarea  name="data[<?php echo e($category); ?>][<?php echo e($question->id); ?>][suggestion]" class="editers_questionAndnotes" rows="2"><?php echo $data['data'][$category][$question->id][suggestion]; ?></textarea>
                                    </div>
                                </div>
                            </div>
                           ...
                           <input type="hidden" name="data[<?php echo e($category); ?>][<?php echo e($question->id); ?>][score]" id="score_<?php echo e($question->id); ?>"  value="<?php echo $data['data'][$category][$question->id][score]; ?>" />
                           </div>
                           <?php $offset++; $count++;  } ?>
                        <?php endforeach; ?>
                    </div>
                                    ...
                                    <div id="graphdiv-<?php echo e($counter); ?>" class="col-5-7 mrgbt20 relative Box pultop15">
                                        <div class="bardiv-<?php echo e($counter); ?>">
                                            ...
                                            <div class="left">
                                                ...
                                                <input type="hidden" name="graphs[<?php echo e($barid); ?>]" data-slider="true" data-slider-highlight="true"  data-slider-range="1,100" value="<?php echo $data['graphs'][$barid]; ?>" />
                                            </div>
                                        </div>
                                                 	...
                                                 	<div id="graphdiv-<?php echo e($counter); ?>" class="col-5-7 mrgbt20 relative Box pultop15">
                                                        <div class="bardiv-<?php echo e($counter); ?>">
                                                            ...
                                                            <div class="left">
                                                                ...
                                                                data-slider-range="1,100" value="<?php echo $data['graphs'][$barid]; ?>" />
                                                            </div>
                                                        </div>
                                                        <span data-id="graphdiv-<?php echo e($counter); ?>" data-value="<?php echo e($graphs); ?>" data-type="graphbar" class="delete_btn mrgtp25 mrgrt70" title="Remove" id="move_1"><i class="fa fa-trash"></i></span>
                                                        <div class="clear"></div>
                    ...
                    <?php if(count($scriptinfo)>0){ ?>
                            ...
                            <?php foreach($scriptinfo['left'] as $leftkey => $leftval){?>
                                <?php if(!empty($leftval) && !is_array($leftval)){?>
                                	<?php if((strtolower($leftval) == "writer" || strtolower($leftval) == "story by")): ?>
                                        	<?php $count_value	=	1; ?>
                                            <?php if(is_array($data['general_info']['left'][$leftval])): ?>
                                                <?php foreach($data['general_info'][left][$leftval] as $key=>$value): ?>
                                                
                                                    <div class="col-1-1 relative" data-div="left_<?php echo e(str_replace(' ','',strtolower($leftval))); ?>_add">
                                                        <div class="col-20-24 mrgbt15" id="move_<?php echo e($count_value); ?>" >
                                                            <?php echo e(Form::label('general_info', $leftval." ".$count_value,['class'=>'it'])); ?>

                                                            <?php echo e(Form::text('general_info[left]['.$leftval.']['.$count_value.']',$value,array('class' => 'text textInput it mrgbt5'))); ?>

                                                            <?php if($count_value != 1): ?>
                                            ...
                                            <?php else: ?>
                                            	<div class="col-1-1 relative" data-div="left_<?php echo e(str_replace(' ','',strtolower($leftval))); ?>_add">
                                                        <div class="col-20-24 mrgbt15" id="move_<?php echo e($count_value); ?>" >
                                                            ...
                                                            <?php echo e(Form::text('general_info[left]['.$leftval.'][1]',$value,array('class' => 'text textInput it mrgbt5'))); ?>
                                            ...
                                            <?php endif; ?>
                                            <a data-count="<?php echo e(($count_value - 1)); ?>" data-div="left_<?php echo e(str_replace(' ','',strtolower($leftval))); ?>_add" class="add_other col-20-24 mrgbt15"><i class="fa fa-plus"></i>&nbsp;Add <?php echo e($leftval); ?></a>
                                        <?php else: ?>                                    
                                    <div class="col-1-1 relative">
                                        <div class="col-20-24 mrgbt15" id="move_<?php echo e($idcount); ?>">
                                        	...
                                        	<?php echo e(Form::text('general_info[left]['.$leftval.']',$data['general_info']['left'][$leftval],array('class' => 'text textInput it mrgbt5'))); ?>
                            		...
                            		<?php foreach($leftval as $other): ?>
                                    	 <div class="col-1-1 mrgbt15 relative">
                                            <div class="col-20-24" id="move_<?php echo e($idcount); ?>">
                                                ...
                                                <?php echo e(Form::text('general_info[left]['.$other.']',$data['general_info'][left][$other],array('class' => 'text textInput it mrgbt5'))); ?>
                          ...
                          <?php if(isset($scriptinfo['right']) && count($scriptinfo['right'])){ ?>
                            <?php foreach($scriptinfo['right'] as $leftkey => $leftval){?>
                                <?php if(!empty($leftval) && !is_array($leftval)){?>
                                	<?php if((strtolower($leftval) == "writer" || strtolower($leftval) == "story by") && is_array($data['general_info']['right'][$leftval])): ?>
                                        	<?php $count_value	=	1; ?>
                                        	<?php foreach($data['general_info']['right'][$leftval] as $key=>$value): ?>
                                            
                                            	<div class="col-1-1 relative" data-div="left_<?php echo e(str_replace(' ','',strtolower($leftval))); ?>_add">
                                                    <div class="col-20-24 mrgbt15" id="move_<?php echo e($count_value); ?>" >
                                                        <?php echo e(Form::label('general_info', $leftval." ".$count_value,['class'=>'it'])); ?>

                                                        <?php echo e(Form::text('general_info[right]['.$leftval.']['.$count_value.']',$value,array('class' => 'text textInput it mrgbt5'))); ?>
                                    ...
                                    <div class="col-1-1 relative">
                                        <div class="col-20-24 mrgbt15" id="move_<?php echo e($idcount); ?>">
                                        	...
                                        	<?php echo e(Form::text('general_info[right]['.$leftval.']',$data['general_info']['right'][$leftval],array('class' => 'text textInput it mrgbt5'))); ?>
                            		...
                            		<?php foreach($leftval as $other): ?>
                                    	 <div class="col-1-1 mrgbt15 relative">
                                            <div class="col-20-24" id="move_<?php echo e($idcount); ?>">
                                                ...
                                                <?php echo e(Form::text('general_info[right]['.$other.']',$data['general_info']['right'][$other],array('class' => 'text textInput it mrgbt5'))); ?>
                                    ...
                                    <div class="col-20-24">
                                        <?php echo e(Form::label('character_break', $value,['class'=>'it mrgbt10 nofull'])); ?>
                                         ...
                                         <?php if($charector['character_inst']!=''):?>
                                        	...
                                        	<?php endif; ?>		
                                        <?php echo e(Form::textarea('character_break['.$value.']',$data['character_break'][$value],array('class' => 'text it textArea editers', 'rows'=>'2'))); ?>
                                    ...
                                    <div class="col-20-24 mrgbt15">
                                        ...
                                        <?php echo e(Form::label('notes', $value,['class'=>'it nofull'])); ?>
                                         ...
                                         <?php if($inst!=''):?>
                                        	...
                                        	<?php endif; ?>		
                                        <?php echo e(Form::textarea('logsys['.$value.']',$data['logsys'][$value],array('class' => 'text it textArea editers', 'rows'=>'2'))); ?>
                        	...
                        	<?php if(!empty($value) && is_numeric($key)){ ?>
                            	<div id="notes-<?php echo e($counter); ?>" class="col-1-1 relative">
                                    <div class="col-20-24 mrgbt15">
                                        	...
                                        	<?php endif; ?>	
                                            <?php echo e(Form::textarea('notes['.$value.']',$data['notes'][$value],array('class' => 'text it textArea editers', 'rows'=>'2'))); ?>
                        	...
                        	<?php if(count($value)>1){ ?>
                            	<div id="notes-<?php echo e($counter); ?> " class="col-1-1 relative">
                                    <div class="col-20-24 mrgbt15">
                                        	...
                                        	<?php endif; ?>	
                                            <?php echo e(Form::textarea('notes['.$value[0].']',$data['notes'][$value[0]],array('class' => 'text it textArea editers', 'rows'=>'2'))); ?>
            ...
            <?php echo Html::image("public/images/icons/cancel.png","Close This Dilog Box",["onclick"=>"javascript:$(\"#message-overlayer\").trigger('click')","class"=>"closeMessageBox"]); ?>
                ...
                <div class="col-1-1 pul15">
                    <div class="col-1-1 ymrg10">
                        <?php echo e(Form::text('script_title',$script->title,array('class' => 'text textInput it','placeholder'=>'Script Title', 'required'))); ?>

                    </div>
                    <div class="col-1-1 ymrg10">
                        <?php echo e(Form::text('script_draft',$script->draft,array('class' => 'text textInput it','placeholder'=>'Draft'))); ?>

                    </div>
                    <div class="col-1-1 ymrg10">
                        <?php echo e(Form::text('script_date',date('F d, Y',strtotime($script->created_date)),array('class' => 'text textInput it datepicker' ,'placeholder'=>'Date','readonly'))); ?>

                    </div>
                    <div class="col-1-1 ymrg10">
                        <?php echo e(Form::textarea('script_notes',$script->privatenote->note,array('class' => 'text it textArea', 'rows'=>'2' ,'placeholder'=>'Private Notes'))); ?>

                    </div>
                </div>
                <div class="col-1-1 xpul20 pulbotm20">
                    <div class="col-1-1">
                        <?php echo e(Form::button('CANCEL',array('class'=>'btn btn-icon btn-primary fa-times right','id'=>'cancelreport'))); ?>

                        <?php echo e(Form::submit('UPDATE',array('class'=>'btn btn-icon btn-primary fa-save right mrgrt15'))); ?>
